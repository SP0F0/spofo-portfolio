...
@Getter
@Builder
public class TotalPortofoliosStatistic {
    ...
    public static TotalPortofoliosStatistic of(List<PortfolioStatistic> portfolioStatistics) {
        ...
        return TotalPortofoliosStatistic.builder()
